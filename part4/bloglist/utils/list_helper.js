...
first calculate how many blogs each author has.
   reduce to an array where each element is in this form
  {
...
second fund the author with most blogs.
  reduce again keeping the author with most blogs in the accumilator
*/

const mostBlogs = (blogs) => Object.values(blogs.reduce((acc, blog) => {
  ...
  return author.blogs < acc.blogs ? acc : author
}, {})
